...
function isExcludedTransfer(txn) {
...
function parsePlaidDate(ymd) {
    return new Date(`${ymd}T12:00:00.000Z`);
}
function isWithinInitialWindow(txnDateYmd, initialWindowDays) {
    if (!initialWindowDays)
        return true;
...
async function upsertTransaction(userId, linkedAccountId, txn, summary, initialWindowDays) {
...
async function applyRemovedTransactions(userId, removed, summary) {
...
export async function syncLinkedAccountTransactions(userId, linkedAccountId, initialWindowDays) {
